...
![](adafruit_relay.jpeg){width="210"}

This simple and cheap relay is a great demonstration of using `rpigpior()` to drive a device. Obtain one of these relays from [Adafruit](https://www.adafruit.com/product/4409) for the low-low price of \$6.95.

```{r, eval=FALSE} # Relay #1 connected to GPIO17, board pin 11. # Relay #2 connected to GPIO27, board pin 13. rpi_set(pin_number = c(11, 13), onOff = 1) # turn both relays on rpi_set(pin_number = c(11, 13), onOff = 0) # turn both relays off}
```
