...
if (getPressure) {
  ...
  raw_pressure <- rpi_i2c_get(chip_address = 0x77,
                                 data_address = 0xf7,
                                 data_size = "w")
...
dig_P1 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x8E,
                                    data_size = "w")

dig_P2 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x90,
                                    data_size = "w")

dig_P3 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x92,
                                    data_size = "w")

dig_P4 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x94,
                                    data_size = "w")

dig_P5 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x96,
                                    data_size = "w")

dig_P6 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x98,
                                    data_size = "w")

dig_P7 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x9A,
                                    data_size = "w")

dig_P8 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x9C,
                                    data_size = "w")

dig_P9 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0x9E,
                                    data_size = "w")
...
if (getHumidity) {
  ...
  raw_humidity <- rpi_i2c_get(chip_address = 0x77,
                                 data_address = 0xfd,
                                 data_size = "w")
...
dig_H1 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0xA1,
                                    data_size = "b")

dig_H2 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0xE1,
                                    data_size = "w")

dig_H3 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0xE3,
                                    data_size = "b")

??? 0xE4 / 0xE5[3:0]
dig_H4 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0xE4,
                                    data_size = "w")
??? 0xE5[7:4]/0xE6
dig_H5 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0xE5,
                                    data_size = "w")

dig_H6 <- rpi_i2c_get(chip_address = 0x77,
                                    data_address = 0xE7,
                                    data_size = "b")
