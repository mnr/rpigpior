...
# cppFunction('Rcpp::IntegerVector BME280_compensate_T_int32(Rcpp::IntegerVector adc_T, Rcpp::IntegerVector dig_T1, Rcpp::IntegerVector dig_T2, Rcpp::IntegerVector dig_T3)
# {
...
t_var1 <- bitShiftR((bitShiftR(raw_temperature, 3) - bitShiftL(dig_T1_value, 1)) * dig_T2_value, 11)

t_var2 <- bitShiftR(bitShiftR((bitShiftR(adc_T, 4) - dig_T1_value) * (bitShiftR(adc_T, 4) - dig_T1_value), 12) * dig_T3_value, 14)

t_fine <- t_var1 + t_var2;
temperature_celsius <- bitwShiftR((t_fine * 5 + 128),8)
...
print(paste("temperature (c):", (temperature_celsius/100), "pressure (Pa):", (pressure/256),
"humidity (%RH):", (humidity/1024)))
